...
public class UserInterface : MonoBehaviour
{
    ...
    [Header("BUILDING COMPONENT CATALOG")]
    ...
    private void GetCurrentMenuElement() {
        ...
        if(currentMenuItemIndex != previousMenuItemIndex) {
            ...
            menuElements[currentMenuItemIndex].ButtonBackground.color = UseGradient ? 
                HighlightedButtonGradient.Evaluate(1f / menuElements.Count * currentMenuItemIndex) : HighlightedButtonColor;
