...
namespace Sebastian.Geometry
{
    public partial class CompositeHoleShape
    {
        ...
        public class CompositeHoleShapeData
        {
            public readonly Vector2[] points;
            public readonly Polygon polygon;
            public readonly int[] triangles;

            public List<CompositeHoleShapeData> parents = new List<CompositeHoleShapeData>();
            public List<CompositeHoleShapeData> holes = new List<CompositeHoleShapeData>();
            public bool IsValidShape { get; private set; }

            public CompositeHoleShapeData(Vector3[] points)
            {
            ...
            public bool IsParentOf(CompositeHoleShapeData otherShape)
            {
            ...
            public bool OverlapsPartially(CompositeHoleShapeData otherShape)
            {
